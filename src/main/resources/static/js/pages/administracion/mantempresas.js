...
function getUsuarios(){
	...
	$.ajax({
		type : "GET",
		url : context + "/private/empresa/all",		
		success : function(data) {
			...
			if (jsonobject.estado == 'ERROR') {
				...
				$.each(jsonobject.datos, function(index, element) {
					...
					var estado = "";
					if(element.contrato.estado != null){						
						if(element.contrato.estado == true){
					...
					table.rows.add( [ {
							...
							"2": siNuloVacio(element.contrato.nrocontrato),
							"3": siNuloVacio(formatFecha(element.contrato.fechadesde)),
							"4": siNuloVacio(formatFecha(element.contrato.fechahasta)),
							"5": siNuloVacio(element.contrato.observaciones),
							"6": estado,
							"7": siNuloCero(element.contrato.idcontrato),
