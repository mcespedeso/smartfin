...
//	var msg = sjcl.encrypt(encrypt, "Hi Alice!");

//	console.log(sjcl.decrypt(encrypt, localStorage.usuario));
...
function getAllEventos(){
	...
	$.ajax({
		type : "GET",
		url : context + "/private/calendario/all",		
		success : function(data) {
			...
			if (jsonobject.estado == 'ERROR') {
				...
				$.each(jsonobject.datos, function(index, element) {
		                ...
		                var myEvent = {
		                		  id: element.usuario.empresa.descripcion,
